...
%% PicoScope 2000 Series - Dual Channel Block Data Capture
% Modified to capture both Channel A and B with dual y-axis display

%% AWG Configuration Parameters
awgFrequency = fs/4;                    % Frequency in Hz
awgAmplitude = 2000;                    % Peak-to-peak amplitude in mV (2V)
awgOffset = 0;                          % DC offset in mV
